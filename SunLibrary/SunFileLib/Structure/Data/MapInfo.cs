...
namespace SunLibrary.SunFileLib.Structure.Data
{
    public class MapInfo //Credits to Bui for some of the info
    {
        ...
        public FieldLimit fieldLimit = FieldLimit.FIELD_OPTION_NONE;
        ...
        public SunBool fly = null;
        public SunBool noMapCmd = null;
        public SunBool partyOnly = null;
        public SunBool reactorShuffle = null;
        public string reactorShuffleName = null;
        public SunBool personalShop = null;
        public SunBool entrustedShop = null;
        ...
        public SunBool snow = null;
        public SunBool rain = null;
        ...
        public SunBool expeditionOnly = null;
        ...
        #region Unknown optional

        public int? moveLimit = null;
        public string mapDesc = null;
        public string mapName = null;
        public string streetName = null;
        public SunBool miniMapOnOff = null;
        public SunBool noRegenMap = null; //610030400
        public List<int> allowedItem = null;
        public float? recovery = null; //recovery rate, like in sauna (3)
        public SunBool blockPBossChange = null; //something with monster carnival
        public SunBool everlast = null; //something with bonus stages of PQs
        public SunBool damageCheckFree = null; //something with fishing event
        public float? dropRate = null;
        public SunBool scrollDisable = null;
        public SunBool needSkillForFly = null;
        public SunBool zakum2Hack = null; //JQ hack protection
        public SunBool allMoveCheck = null; //another JQ hack protection
        public SunBool VRLimit = null; //use vr's as limits?
        public SunBool consumeItemCoolTime = null; //cool time of consume item

        #endregion Unknown optional

        //Special
        public List<SunProperty> additionalProps = new List<SunProperty>();
        ...
        public string strCategoryName = "HaCreator"; // In MS, this is the continent/area the map is located in. E.G. El Nath = Ossyria, Sleepywood = victoria
        public int id = 0;
        ...
        public MapInfo(SunImage image, string strMapName, string strStreetName, string strCategoryName)
        {
            this.image = image;
            int? startHour;
            int? endHour;
            ...
            foreach (SunProperty prop in image["info"].SunProperties)
            {
                switch (prop.Name)
                {
                    ...
                    case "allowedItem":
                        ...
                        if (prop.SunProperties != null && prop.SunProperties.Count > 0)
                            foreach (SunProperty item in prop.SunProperties)
        ...
        public static Rectangle? GetVR(SunImage image)
        {
        ...
        public void Save(SunImage dest, Rectangle? VR)
        {
            ...
            foreach (SunProperty prop in additionalProps)
            {
