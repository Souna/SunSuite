...
namespace HaCreator.MapEditor.Instance
{
    public abstract class LifeInstance : BoardItem, IFlippable, ISerializable
    {
        ...
        private SunBool flip;
        private SunBool hide;
        private int? info; //no idea
        private int? team; //for carnival

        public LifeInstance(MapleDrawableInfo baseInfo, Board board, int x, int y, int rx0Shift, int rx1Shift, int yShift, string limitedname, int? mobTime, SunBool flip, SunBool hide, int? info, int? team)
            : base(board, x, y, -1)
        {
