...
namespace HaCreator.MapEditor.Instance
{
    public class PortalInstance : BoardItem, ISerializable
    {
        ...
        private int? _delay;
        private SunBool _hideTooltip;
        private SunBool _onlyOnce;
        ...
        public PortalInstance(PortalInfo baseInfo, Board board, int x, int y, string pn, string pt, string tn, int tm, string script, int? delay, SunBool hideTooltip, SunBool onlyOnce, int? horizontalImpact, int? verticalImpact, string image, int? hRange, int? vRange)
            : base(board, x, y, -1)
        {
        ...
        public new class SerializationForm : BoardItem.SerializationForm
        {
            ...
            public string script;
            public int? delay;
            public SunBool hidett, onlyonce;
