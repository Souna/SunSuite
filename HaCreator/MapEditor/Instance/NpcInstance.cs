...
namespace HaCreator.MapEditor.Instance
{
    public class NpcInstance : LifeInstance
    {
        ...
        public NpcInstance(NpcInfo baseInfo, Board board, int x, int y, int rx0Shift, int rx1Shift, int yShift, string limitedname, int? mobTime, SunBool flip, SunBool hide, int? info, int? team)
