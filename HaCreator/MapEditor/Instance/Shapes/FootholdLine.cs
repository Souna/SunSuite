...
namespace HaCreator.MapEditor.Instance.Shapes
{
    ...
    {
        private SunBool _cantThrough;
        private SunBool _forbidFallDown;
        private int? _piece;
        private int? _force;
        ...
        public FootholdLine(Board board, MapleDot firstDot, MapleDot secondDot, SunBool forbidFallDown, SunBool cantThrough, int? piece, int? force)
            : base(board, firstDot, secondDot)
        {
        ...
        public FootholdLine(Board board, MapleDot firstDot, SunBool forbidFallDown, SunBool cantThrough, int? piece, int? force)
            : base(board, firstDot)
        {
            this._cantThrough = cantThrough;
            this._forbidFallDown = forbidFallDown;
        ...
        public bool IsWall
        { get { return FirstDot.X == SecondDot.X; } }

        public int? Force
        { get { return _force; } set { _force = value; } }
        public int? Piece
        { get { return _piece; } set { _piece = value; } }
        public SunBool ForbidFallDown
        { get { return _forbidFallDown; } set { _forbidFallDown = value; } }
        public SunBool CantThrough
        { get { return _cantThrough; } set { _cantThrough = value; } }
        public int LayerNumber
        { get { return ((FootholdAnchor)FirstDot).LayerNumber; } set { throw new NotImplementedException(); } }
        public int PlatformNumber
        { get { return ((FootholdAnchor)FirstDot).PlatformNumber; } set { throw new NotImplementedException(); } }
        ...
        {
            public SunBool cantthrough, forbidfalldown;
