...
namespace HaCreator.MapEditor.Instance
{
    public class MobInstance : LifeInstance
    {
        ...
        public MobInstance(MobInfo baseInfo, Board board, int x, int y, int rx0Shift, int rx1Shift, int yShift, string limitedname, int? mobTime, SunBool flip, SunBool hide, int? info, int? team)
