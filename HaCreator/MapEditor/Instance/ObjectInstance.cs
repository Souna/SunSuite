...
namespace HaCreator.MapEditor.Instance
{
    public class ObjectInstance : LayeredItem, IFlippable, ISnappable
    {
        ...
        private SunBool _r;
        private string name;
        private SunBool _hide;
        private SunBool _reactor;
        private SunBool _flow;
        private int? _rx, _ry, _cx, _cy;
        private string _tags;
        private List<ObjectInstanceQuest> questInfo;

        public ObjectInstance(ObjectInfo baseInfo, Layer layer, Board board, int x, int y, int z, int zM, SunBool r, SunBool hide, SunBool reactor, SunBool flow, int? rx, int? ry, int? cx, int? cy, string name, string tags, List<ObjectInstanceQuest> questInfo, bool flip)
        ...
        public SunBool flow
        { get { return _flow; } set { _flow = value; } }
        public SunBool reactor
        { get { return _reactor; } set { _reactor = value; } }
        public int? rx
        { get { return _rx; } set { _rx = value; } }
        public int? ry
        { get { return _ry; } set { _ry = value; } }
        public int? cx
        { get { return _cx; } set { _cx = value; } }
        public int? cy
        { get { return _cy; } set { _cy = value; } }
        public List<ObjectInstanceQuest> QuestInfo
        { get { return questInfo; } set { questInfo = value; } }
        ...
        public new class SerializationForm : LayeredItem.SerializationForm
        {
            ...
            public SunBool r;
            public string name;
            public SunBool hide, reactor, flow;
