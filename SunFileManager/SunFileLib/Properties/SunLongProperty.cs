...
namespace SunFileManager.SunFileLib.Properties
{
    ...
    /// <br>A SunLongProperty may be associated with a SunDirectory or SunImageProperty.</br>
    /// </summary>
    public class SunLongProperty : SunProperty
    {
        ...
        /// <br>Long = 4</br>
        /// </summary>
        public override SunPropertyType PropertyType { get { return SunPropertyType.Long; } }
        ...
        /// </summary>
        public SunLongProperty(string name) { this.name = name; }
